...
- (void)didShowAdWithTag: (NSString *) tag {
    ...
    s3eEdkCallbacksEnqueue(S3E_EXT_HEYZAP_HASH, HZVIDEO_SHOW, (void *)tag_c, (strlen(tag_c) + 1 /*Include `\0`*/));
}
...
- (void)didFailToShowAdWithTag: (NSString *) tag andError: (NSError *)error {
    const char *tag_c = [(tag ? tag : @"") UTF8String];
    s3eEdkCallbacksEnqueue(S3E_EXT_HEYZAP_HASH, HZVIDEO_FAILED_TO_SHOW, (void *)tag_c, (strlen(tag_c) + 1 /*Include `\0`*/));
}
...
- (void)didReceiveAdWithTag: (NSString *) tag {
    const char *tag_c = [(tag ? tag : @"") UTF8String];
    s3eEdkCallbacksEnqueue(S3E_EXT_HEYZAP_HASH, HZVIDEO_AVAILABLE, (void *)tag_c, (strlen(tag_c) + 1 /*Include `\0`*/));
}
...
- (void)didFailToReceiveAdWithTag: (NSString *) tag {
    const char *tag_c = [(tag ? tag : @"") UTF8String];
    s3eEdkCallbacksEnqueue(S3E_EXT_HEYZAP_HASH, HZVIDEO_FAILED_TO_FETCH, (void *)tag_c, (strlen(tag_c) + 1 /*Include `\0`*/));
}
...
- (void)didClickAdWithTag: (NSString *) tag {
    const char *tag_c = [(tag ? tag : @"") UTF8String];
    s3eEdkCallbacksEnqueue(S3E_EXT_HEYZAP_HASH, HZVIDEO_CLICK, (void *)tag_c, (strlen(tag_c) + 1 /*Include `\0`*/));
}
...
- (void)didHideAdWithTag: (NSString *) tag {
    const char *tag_c = [(tag ? tag : @"") UTF8String];
    s3eEdkCallbacksEnqueue(S3E_EXT_HEYZAP_HASH, HZVIDEO_HIDE, (void *)tag_c, (strlen(tag_c) + 1 /*Include `\0`*/));
}
